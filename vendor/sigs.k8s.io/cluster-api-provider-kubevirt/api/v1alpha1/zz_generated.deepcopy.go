...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPPoolEntry) DeepCopyInto(out *IPPoolEntry) {
	*out = *in
	if in.Subnets != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPPoolEntry.
func (in *IPPoolEntry) DeepCopy() *IPPoolEntry {
	if in == nil {
		return nil
	}
	out := new(IPPoolEntry)
...
func (in *NetworkConfig) DeepCopyInto(out *NetworkConfig) {
	*out = *in
	if in.IPPool != nil {
		...
		*out = make(map[string]IPPoolEntry, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
